...
vtkSmartPointer< vtkContourFilter > iso0, iso1;

// Define interaction style
class point_picker_style : public vtkInteractorStyleTrackballCamera
{
  public:
    static point_picker_style* New();
    vtkTypeMacro(point_picker_style, vtkInteractorStyleTrackballCamera);
...
vtkStandardNewMacro(point_picker_style);

double measure();
void raycast();
void compute_isosurface0(double);
void compute_isosurface1(double);
void show_isosurface(int);
void hide_isosurface(int);
...
void corn_mri_main_window::slot_compute() {
    ...
    this->ui->measure_text->setText(QString(os.str());
}

corn_mri_main_window::corn_mri_main_window() {
