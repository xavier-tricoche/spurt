...
int main(int argc, char* argv[])
{
    ...
    stations = vtk_utils::make_points(coords);
    stations->GetPoints()->GetData()->SetName("StationsLocations");
    vtk_utils::add_scalars(stations, travel_times);
    ...
    station_glyphs->SetSource(sphere->GetOutput());
    ...
    if (show_pos.size()) {
        ...
        user_glyphs->SetSource(sphere->GetOutput());
    ...
    source_sphere->SetInput(source_pt);
    source_sphere->SetSource(sphere->GetOutput());
    ...
    dist_contour->SetInput(distance);
    ...
    dist_tube->SetInputConnection(dist_contour->GetOutputPort());
    ...
    dist_tube_mapper->SetInputConnection(dist_tube->GetOutputPort());
