...
//
// Project:   FAnToM
// Module:    $RCSfile: FPointCell3D.hh,v $
// Language:  C++
...
#ifndef __FPointCell3D_hh
#define __FPointCell3D_hh
...
/** 
 * The FPointCell3D class is an implementation of the geometric triangle
...
class FPointCell3D : public FCell
{
public: 
   ...
   *none
   */
  FPointCell3D( const vector<FIndex>& vertIds );
  FPointCell3D( const FIndex& vertId );
   ...
   *none
   */
  FPointCell3D( const FIndex* vertIds );
