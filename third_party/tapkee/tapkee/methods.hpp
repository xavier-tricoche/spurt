...
private:
	...
	TapkeeOutput embedKernelLocallyLinearEmbedding()
	{
		...
		return TapkeeOutput(embedding, unimplementedProjectingFunction(), neighbors);
	}
	...
	TapkeeOutput embedIsomap()
	{
		...
		return TapkeeOutput(embedding.first, unimplementedProjectingFunction(), neighbors);
	}
