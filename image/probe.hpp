...
{
public:
    typedef fixed_vector<double, 2> point2_t;
    typedef fixed_vector<double, 2> value2_t;
    typedef fixed_vector<double, 3> point3_t;
    typedef fixed_vector<double, 3> value3_t;
