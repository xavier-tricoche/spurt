    ...
    for p, f, name in zip(pos, vals, names):
        ...
        #modify data
            ...
            for i in range(len(f)):
                ...
                if(mask_value != 0):
                    #Within the mask
                    if(f[i] > control_points[10+2*j][0]  or f[i] < control_points[10-2*j][0]):
