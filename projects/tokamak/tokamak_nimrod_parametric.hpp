#ifndef __tokamak_nimrod_parametric_hpp
#define __tokamak_nimrod_parametric_hpp
...
class tokamak_nimrod_parametric: public tokamak_field
{
public:

	tokamak_nimrod_parametric(const std::string& h5file,
	...
	tokamak_nimrod_parametric* clone() const {
		return new tokamak_nimrod_parametric(*this);
	}
	...
	static void load(const std::string& h5file, const std::string& step,
...
#endif // __tokamak_nimrod_parametric_hpp
